...
public class Level1 implements LevelSample{
	...
	public Level1(Level level , MainPanel panel) {
		this.panel = panel;
		this.level = level;
		wave1 = new Game(1200, 700, "rectangle", "1", "1", "1",panel);
		wave2 = new Game(1200, 700, "circular", "1", "1", "1",panel);
		wave3 = new Game(1200, 700, "rectangle", "1", "2", "1",panel);
		wave4 = new Game(1200, 700, "circular", "1", "2", "1",panel);
	...
	public Level1(Level level) {
		this.level = level;
		wave1 = new Game(1200, 700, "rectangle", "1", "1", "1");
		wave2 = new Game(1200, 700, "circular", "1", "1", "1");
		wave3 = new Game(1200, 700, "rectangle", "1", "2", "1");
		wave4 = new Game(1200, 700, "circular", "1", "2", "1");
