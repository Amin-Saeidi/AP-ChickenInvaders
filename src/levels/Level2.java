...
public class Level2 implements LevelSample {
	...
	public Level2(Level level,MainPanel panel) {
		this.level = level;
		this.panel = panel;
		wave1 = new Game(1200, 700, "rectangle", "1", "2", "1",panel);
		wave2 = new Game(1200, 700, "circular", "2", "1", "1",panel);
		wave3 = new Game(1200, 700, "rectangle", "1", "2", "1",panel);
		wave4 = new Game(1200, 700, "circular", "2", "1", "2",panel);
	...
	public Level2(Level level) {
		this.level = level;
		wave1 = new Game(1200, 700, "rectangle", "1", "2", "1");
		wave2 = new Game(1200, 700, "circular", "2", "1", "1");
		wave3 = new Game(1200, 700, "rectangle", "1", "2", "1");
		wave4 = new Game(1200, 700, "circular", "2", "1", "2");
	...
	public void endOfWave1(){
		if(Level.loaded != true) {
			if(counter == 0) {
				wave1.propertiesBar.setHealth(level.level1.finalWave.propertiesBar.getHealth());
				wave1.propertiesBar.setCoins(0);
				wave1.propertiesBar.setChickens(level.level1.finalWave.propertiesBar.getChickens());
				wave1.temperatureBar.setScore(level.level1.finalWave.temperatureBar.getScore()+level.level1.finalWave.propertiesBar.getCoins());
				wave1.temperatureBar.maximumTemp = level.level1.finalWave.temperatureBar.maximumTemp;
				wave1.propertiesBar.setNumOfBombs(level.level1.finalWave.propertiesBar.getNumOfBombs()+1);				
				counter+=1;
			}
...
public void reflectMethod(URL[] classLoaderPath, String reflectedPath) {
	this.classLoaderURLPath = classLoaderPath;
