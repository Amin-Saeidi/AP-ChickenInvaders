...
public class GameOverMessage implements Animatable {
	...
	public GameOverMessage(double messageX, double messageY, double heightOfImage , double widthOfImage) {
	...
	private void initialize() {
		try {
			messageImage = ImageIO.read(new File("resources/gameover.png"));
		} catch (IOException e) {
			e.printStackTrace();
		}
	}
